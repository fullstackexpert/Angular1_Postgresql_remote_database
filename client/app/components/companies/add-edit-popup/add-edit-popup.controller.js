...
angular.module(app.name).controller('CompaniesAddEditPopupController', function(
    ...
    vm.next1 = function() {
        ...
        if (vm.companyForm.$valid) {
            ...
            $('#Heading1').attr('style', 'background-color: green !important');
            $('#Heading2').attr('style', 'background-color: #822193 !important');
            $('#panel-main').attr('style', 'padding-left: 0px !important;padding-right: 0px !important;height: 300px !important;margin-left: 14px;margin-right: 14px;');
            $('#Collapse2').collapse('show');
        }
        else {
            $('#panel-main').attr('style', 'padding-left: 0px !important;padding-right: 0px !important;height: 300px !important;margin-left: 14px;margin-right: 14px;overflow-y: scroll !important;overflow-x:hidden !important;');
        }
    };

    vm.prev1 = function() {
        vm.sectionstatus = 1;
        $('#Accordion2 .panel-collapse').collapse({
            parent: '#Accordion2',
            toggle: false
        });
        $('#Heading1').attr('style', 'background-color: #822193 !important');
        $('#Heading2').attr('style', 'background-color: lightgrey !important');
